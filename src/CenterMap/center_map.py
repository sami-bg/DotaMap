...
TODO: Looks for enemy outpost, checks x value vs y value to determine if current team is radiant or dire, then finds the
 coordinates of the top-left of the minimap given the whole screen.
